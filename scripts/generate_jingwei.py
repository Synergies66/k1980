...
TOPICS = [
    {
        ...
        'prompt': f"""今天是{TODAY}。你是一位服务于全球读者的首席经济学家，请写一篇今日深度报道。

主题：当前全球宏观经济形势与海外投资者的资产配置策略
...
主题：当前最值得关注的科技或产业趋势，对全球从业者和投资者的影响
...
严格只返回JSON：{{"title":"","summary":"","body":"","tag":"产业洞察","date":"{TODAY}"}}"""
    },
    {
        ...
        'prompt': f"""今天是{TODAY}。你是一位专注全球生活与财富的专栏作家，请写一篇今日深度报道。

主题：新西兰/澳洲/加拿大/英国移民政策或本地经济动态，对海外读者社区的实际影响

要求：
- 选一个最新、最实用的话题
- 标题要让目标读者（海外移民）立刻感到相关（20字内）
- 导语50字内
- 正文600字，用###分3-4个小节
- 要有政策细节、真实案例、具体建议
- 风格犀利务实，不说废话
